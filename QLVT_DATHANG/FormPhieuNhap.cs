...
namespace QLVT_DATHANG
{
    public partial class FormPhieuNhap : Form
    {
        ...
        private void btnChiTietPN_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if(Program.role != "CONGTY")
            {
                btnThem.Enabled = btnXoa.Enabled = btnGhi.Enabled = btnUndo.Enabled = !dgvCTPN.Visible;
            }
            else
            {
                cmbChiNhanh.Enabled = !dgvCTPN.Visible;
            }
            
            btnReload.Enabled = btnThoat.Enabled = !dgvCTPN.Visible;
